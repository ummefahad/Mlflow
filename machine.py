...
with mlflow.start_run():
        lr = ElasticNet(alpha=alpha, l1_ratio=l1_ratio, random_state=42)  # Fix typo in class name
        lr.fit(train_x, train_y)

        predicted_qualities = lr.predict(test_x)  # Fix variable name here
        ...
        mlflow.log_param("rmse", rmse)  # Fix variable name here
